...
<style>
  ...
  .nav-cart-btn .nav-cart-badge {
    ...
    line-height: 1;
    border: 1.5px solid var(--cream, #FDF6EC);
  }
  .nav-cart-btn:hover .nav-cart-badge { border-color: var(--terra, #C9683A); }
  ...
  @media (max-width: 860px) {
    ...
    /* Cart button stays visible on mobile */
...
<nav id="nav">
  ...
  <div class="nav-socials">
    ...
    <a href="https://discord.gg/NahxUMG" class="nav-social-btn" aria-label="Discord" target="_blank" rel="noopener">
  ...
  <!-- Cart button — badge updates via JS on page load -->
  <a href="cart.php" class="nav-cart-btn" aria-label="View cart">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
         stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/>
      <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/>
    </svg>
    <span class="nav-cart-badge cart-badge" id="navCartBadge" style="display:none">0</span>
  </a>
