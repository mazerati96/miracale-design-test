<?php
// data/posts.php
// Blog post data store — flat file version.
// When MySQL is ready, replace this file's contents with a DB query
// and return the same array structure. The blog page won't need any changes.
//
// To add a post: copy one of the entries below and fill in your content.
// 'slug' must be unique and URL-safe (lowercase, hyphens only).
// 'published' => false will hide a post without deleting it.
...
return [
    ...
    [
        ...
        'image'     => null,                  // replace with 'images/blog/post-1.jpg' when ready
        'category'  => 'Updates',
    ...
    [
        ...
        'body'      => '<p>Spring is officially here and that means craft fair season is kicking off! I\'ve been in full preparation mode — building up inventory, making new display pieces, and figuring out what sold best last year.</p>
                        ...
                        <p>This year I\'m bringing a bigger selection of clay animals, some new watercolor prints, and a whole batch of keychains that I\'m really excited about. Check the Events section below for dates and locations — I\'d love to see you there!</p>',
        'image'     => null,
        'category'  => 'Events',
        'author'    => 'Miracale Design',
        'published' => true,
